    ...
    <div className="max-w-3xl mx-auto bg-white p-6 rounded shadow-md mt-6">
      ...
      <div className="space-y-6 text-gray-800">
        <div>
          ...
          <p>Phone: <a href="tel:+27728037223" className="text-blue-600 hover:underline">072 803 7223</a></p>
        </div>
        ...
        <div>
          ...
          <p>Phone: <a href="tel:+27646519166" className="text-blue-600 hover:underline">064 651 9166</a></p>
        </div>

        <div>
          <h3 className="text-lg font-semibold">Morena Sehlako</h3>
          <p>Email: <a href="mailto:morenamcguy@gmail.com" className="text-blue-600 hover:underline">morenamcguy@gmail.com</a></p>
          <p>Phone: <a href="tel:+27781363268" className="text-blue-600 hover:underline">078 136 3268</a></p>
        </div>
      </div>
